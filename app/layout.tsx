...
function BottomNav() {
  const navItems = [
    ...
    { href: "/tyres", icon: "tyre", label: "Tyres" },
...
function NavItem({ href, icon, label }: { href: string; icon: string; label: string }) {
  const icons: Record<string, string> = {
    ...
    tyre: `<circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="2" fill="none"/><circle cx="12" cy="12" r="4" stroke="currentColor" strokeWidth="2" fill="none"/><line x1="12" y1="3" x2="12" y2="8" stroke="currentColor" strokeWidth="2"/><line x1="12" y1="16" x2="12" y2="21" stroke="currentColor" strokeWidth="2"/><line x1="3" y1="12" x2="8" y2="12" stroke="currentColor" strokeWidth="2"/><line x1="16" y1="12" x2="21" y2="12" stroke="currentColor" strokeWidth="2"/>`,
